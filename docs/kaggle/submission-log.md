...
| SUB-007 | *(pending)* | EXP-007 | `k07_feature_selection` @ *(commit)* | v3 + temporal-stability selection (drop raw ids, time-consistency filter) | *(pending)* | *(pending)* | private ≥ 0.9078 with smaller CV-LB gap | *(pending)* | *(pending)* |
