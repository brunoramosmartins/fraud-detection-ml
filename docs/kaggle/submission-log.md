...
| SUB-006 | 2026-07-11 | EXP-006 | `k06_full_aggregation` @ *(commit)* | v3: full aggregation engine (multi-UID mean/std/nunique, 64 feats) | 0.9421 | 0.9561 ± 0.0121 | private ~0.92-0.93 (confirmatory, closes +0.029 gap) | **0.9377** | **0.9078** |
| SUB-007 | 2026-07-11 | EXP-007 | `k07_feature_selection` @ *(commit)* | v3 + temporal-stability selection (drop 6 raw ids + 19 time-inconsistent) | 0.9383 | 0.9557 ± 0.0133 | private ≥ 0.9078 with smaller CV-LB gap | **0.9344** | **0.9077** |
